  ...
  <tr valign="top">
	...
	<blockquote><br><br>
	  ...
	  <b>The Midwinter Madrigal Feast</b> will be held Friday and Saturday, <?php echo $madrigal_date ; ?>. For more information and to order tickets, <a href="http://cmrf.org.ohio-state.edu/madrigal.php">click here</a>.
        ...
        <p><b>The Medieval & Renaissance Faire at The Ohio State University</b> will be held
	<?php echo $fair_date . ', ' . $fair_year ;?>, and will take place from 11 a.m. until 6 p.m. on the OSU Mirror Lake, South Oval and West Lawn areas. The theme and title of the event have not been announced.
        </p>
	...
	<ul type=disc>
	  ...
	  <li><b>Rules and Regulations:</b>  Pets are allowed on leashes, Weapons must be sheathed and peace-tied (no drawn weapons are allowed on site, other than those that are being used by performers in CMRF-approved shows), No open containers of alcohol are allowed on campus grounds. 
	  </li>
	</ul>
